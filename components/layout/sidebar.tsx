        ...
        >
          <div
            style={{
              ...
              overflow: "hidden",
              background: surface.logoPlate,
              border: collapsed ? `1px solid ${surface.logoPlateBorder}` : "none",
              padding: 0,
              display: "inline-flex",
              alignItems: "center",
          ...
          >
            <Image
              src={collapsed ? "/mindbase-sidebar-mark.jpeg" : "/mindbase-sidebar-full.jpeg"}
              alt="Mindbase"
              width={brandWidth}
              height={brandHeight}
              priority
